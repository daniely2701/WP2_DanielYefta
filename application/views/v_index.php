<section> <h1><?php echo $judul ?></h1> <p align="justify">Pada pengertian codeigniter di atas 
...
jauh dalam belajar codeigniter.</p> <p>MVC adalah teknik atau konsep yang memisahkan 
komponen utama menjadi tiga komponen yaitu model, view dan 
controller.</p> <ol type=”a”> <li>Model</li> <p align="justify">Model adalah kelas yang merepresentasikan atau 
...
objek lingkaran sebagai kelas model.</p> <p align="justify">Sebagai catatan, Semua model harus disimpan di 
dalam folder application\models</p> <li>View</li> <p align="justify">View merupakan bagian yang menangani halaman user 
...
intruksi.</p> <p align="justify">Dari penjelasan tentang model view dan controller 
